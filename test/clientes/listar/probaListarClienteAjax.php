				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     	    pass: passwd,
					     	    agencia: agencia},
	   					 url:  'http://apirest/cliente/' + id_cliente,
	    				 type: 'POST',
	    				 ...
	    				 success: function(data, status, jqXHR) {
	    				 	...
	    				 	if(data["message"]){
	    				 		...
	    				 		$("#container ul").append('<li>'+ '-Error- No existen clientes con ese identificador </li>');
	    				 	}
			...
			function mostrarResultado(datos){
				if(!entrado){
					entrado = true;
						...
						$("#tabs").append('<li>'+ "ID CLIENTE: "+datos["id_cliente"] + '</li>');
