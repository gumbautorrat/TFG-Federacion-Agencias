<?php 
  ...
  //Recogemos los datos del cliente seleccionado en la pag anterior
...
<head>
	...
	<title>Actualizar Propietarios <?php echo TITULO ?></title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navegacion-fm">
					<ul class="nav navbar-nav">
						<li class="active"><a>Actualizar Cliente</a></li>
					</ul>
				...
				<div class="row">
					...
					<div class="col-xs-7">
						<div class="panel panel-default ">
							<div class="panel-heading"><center><h4>Actualizar Cliente</h4></center></div>
						</div>
		  			</div>
		  		</div>
		  		<br>
...
if(isset($_POST['actualizar'])){
	...
	$dni        = $_POST["inputDni"];
  	...
  	$cliente = new ClienteWSClientes();

  	//Hacemos la peticion al servicio web de clientes y obtenemos la respuesta a la peticion de actualizacion en formato JSON
    $resultadoJSON = $cliente->sendActualizarCliente($user,$pass,$agencia,$id,$id_agencia,$dni,$nombre,
	...
	$url_destino = "clientes.php";

	if(strcmp($resultado->message,"Operation Succesful") == 0){
		echo "<script>mostrarMensaje(\"El cliente ha sido actualizado correctamente\",'".$url_destino."');</script>";
	}elseif(strcmp($resultado->message,"Autentication Failure") == 0){
		echo "<script>mostrarMensaje(\"No tienes permisos para actualizar clientes o el cliente que intentas actualizar no es de tu agencia\",'".$url_destino."');</script>";
	}else{
