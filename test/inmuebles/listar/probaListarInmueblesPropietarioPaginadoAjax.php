				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     		...
					     		limit: limit,
					     		offset: offset},
	   					 url:  'http://apirest/inmuebles_propietario_paginado/' + id_agencia,
	    				 type: 'POST',
	    				 ...
	    				 success: function(data, status, jqXHR) {
	    				 	...
	    				 	if(data["message"]){
	    				 		...
	    				 		$("#container ul").append('<li>'+ '-Error- No existen inmuebles para esa agencia o para ese propietario</li>');
	    				 	}
