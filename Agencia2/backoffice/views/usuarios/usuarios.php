...
<html>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navegacion-fm">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#">Gestión Usuarios</a></li>
						<!--<li class="dropdown">
						...
						<select class="form-control" name="tipo_filtro">
							<?php 
								if(isset($_POST['tipo_filtro']) && isset($_POST['valor_filtro'])){
									...
									if($_POST['tipo_filtro'] == 'usuario'){
										echo "<option value=\"usuario\" selected=\"true\">Usuario</option>";
									}else{
	...
	<div class="<?php echo TABLA_CLASS ?>" id="main"> 
		<div class="panel-heading"><center><b>Listado de Usuarios</b><center></div>
	...
	<?php 
		...
		echo "<script>";
			...
			echo "main(user,passwd,tipo_filtro,filtro,agencia,3);";
