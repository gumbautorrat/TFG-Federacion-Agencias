		...
		<script>
			...
			$(function(){
				$("#btn-1").on("click",function(){
					...
					// id demanda a actualizar
					var id_demanda  = $("#id_dem").val();
					...
					$.ajax({
					     data: {user: user, 
					     	    ...
					     	    agencia: agencia,
					     		compartir: compartir},
	   					 url:  'http://apirest/demandas/compartir/' + id_demanda,
	    				 type: 'PUT',
		...
		<div class="main container">
			...
			<div class="col-md-8">
				<div class="list-group">
					<center><a class="list-group-item active"><h2>Test Compartir Demanda</h2></a>
					<a class="list-group-item"><b>http://localhost/apirest_dem/demandas/compartir/:id_demanda </b></a>
						...
						<div class="form-group">	
							<div class="checkbox">
								...
								<div class="col-md-2">
									...
									<input id="id_dem" type="text" class="form-control inp" value="">
								</div>
