		...
		<script>
				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     	    pass: passwd,
					     	    agencia: agencia},
	   					 url:  'http://apirest/tipos_operacion/',
	    				 type: 'POST',
	    				 ...
	    				 success: function(data, status, jqXHR) {
	    				 	...
	    				 	if(data["message"]){
	    				 		...
	    				 		$("#tabs").append('<li> NO EXISTE NINGÚN TIPO OPERACIÓN </li>');
	    				 	}
			...
			function mostrarResultado(datos){
				if(!entrado){
					...
					$("#tabs").append('<li>"LISTADO DE TODOS LOS TIPOS DE OPERACION : </li><br/>');
					for(i = 0; i < datos.length; i++) {
						$("#tabs").append('<li>'+ "NOMBRE: "+datos[i]["id_tipo"] + '</li>');
