				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     		...
					     		limit: limit,
					     		offset: offset},
	   					 url:  'http://apirest/operaciones_cliente_paginado/' + id_agencia,
	    				 type: 'POST',
	    				 ...
	    				 success: function(data, status, jqXHR) {
	    				 	...
	    				 	if(data["message"]){
	    				 		...
	    				 		$("#container ul").append('<center><li>'+ '-Error- No existen operaciones para esa agencia o para ese cliente</li></center>');
	    				 	}
	    				 ...
	    				 error: function (jqXHR, status) {            
              			 	...
              			 	console.log(status);
	    				 	console.log(jqXHR);
	    				 	$("#container ul").append('<center><li>'+ jqXHR["responseText"] + '</center></li>');
         				 }
					});
		...
		<div class="main container">
			...
			<div class="col-md-6">
				<div class="list-group">
					<center><a class="list-group-item active"><h2>Test Listar las Operaciones de un Cliente (Paginado)</h2></a>
					<a href="#" class="list-group-item"><b>http://localhost/apirest_ope/operaciones_cliente_paginado/:id_agencia</b></a>
