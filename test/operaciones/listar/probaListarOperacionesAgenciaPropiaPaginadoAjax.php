				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     		...
					     		limit: limit,
					     		offset: offset},
	   					 url:  'http://apirest/operaciones_agencia_propia/',
	    				 type: 'POST',
		...
		<div class="main container">
			...
			<div class="col-md-6">
				<div class="list-group">
					<center><a class="list-group-item active"><h2>Test Listar Todas las Operaciones de la agencia del usuario (Paginado)</h2></a>
					<a href="#" class="list-group-item"><b>http://localhost/apirest_ope/operaciones/</b></a>
