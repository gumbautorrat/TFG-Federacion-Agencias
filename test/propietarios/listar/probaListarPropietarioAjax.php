				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     	    pass: passwd,
					     	    agencia: agencia},
	   					 url:  'http://apirest/propietario/' + id_propietario,
	    				 type: 'POST',
	    				 ...
	    				 success: function(data, status, jqXHR) {
	    				 	...
	    				 	if(data["message"]){
	    				 		...
	    				 		$("#container ul").append('<li>'+ '-Error- No existe ningún propietario con ese identificador </li>');
	    				 	}
			...
			function mostrarResultado(datos){
				if(!entrado){
					entrado = true;
						...
						$("#tabs").append('<li>'+ "ID PROPIETARIO: "+datos["id_propietario"] + '</li>');
