...
/*Se diferencia de probaListar en que, en el procedimiento almacenado que se ejecuta 
CALL obtenerFotosAgencia(?,?) recibe tambien el parametro agencia y obliga a que los 
inmuebles sean de esa agencia */
				...
				$("#btn-1").on("click",function(){
					...
					$.ajax({
					     data: {user: user, 
					     	    pass: passwd,
					     	    agencia: agencia},
	   					 url:  'http://apirest/fotos_agencia/' + id_inmueble,
	    				 type: 'POST',
