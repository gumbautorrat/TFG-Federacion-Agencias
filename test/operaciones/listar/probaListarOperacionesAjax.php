		...
		<div class="main container">
			...
			<div class="col-md-6">
				<div class="list-group">
					<center><a class="list-group-item active"><h2>Test Listar Todas las Operaciones</h2></a>
					<a href="#" class="list-group-item"><b>http://apirest/operaciones/</b></a>
