...
<html>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navegacion-fm">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#">Gestión Propietarios</a></li>
						<!--<li class="dropdown">
					...
					<form action="propietarios.php" class="navbar-form navbar-right col-md-3 hidden-xs hidden-sm" role="search" method="post">
	...
	<div class="<?php echo TABLA_CLASS ?>" id="main"> 
		<div class="panel-heading"><center><b>Listado de Propietarios</b><center></div>
	...
	<?php 
		...
		echo "<script>";
			...
			echo "main(user,passwd,tipo_filtro,filtro,agencia,1);";
	...
	<!-- Dialog -->
	<div id="dialog" title="Eliminar Propietario" style="display:none;">
    	<p id="mensaje"></p>
    </div>
    <!-- Dialog -->
